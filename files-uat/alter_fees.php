...
if(isset($_REQUEST["cs_id"]))	{ 
	...
	$stmt = $mysqli->prepare("select b.first_name,c.class_name,c.medium from class_stud_master a,stud_regist_master b,class_master c where a.student_id = b.registration_id 	and a.class_id=c.class_id and  cs_id=? and a.fy_id =? and a.is_delete=1 and b.is_delete=1");
										...
										<div class="form-body">
											...
											<table id="table1" class="table table-striped table-hover">
													...
													if(isset($_REQUEST["stf_id"]))	{
														...
														$stmt = $mysqli->prepare("select c.fee_name_id,c.fee_name,b.fee_amount from fee_master a,fee_struct_master b,fee_name_master c where a.fee_id=b.fee_id and b.fee_name_id=c.fee_name_id and a.class_id=? and b.is_delete=1 and c.is_delete=1");
