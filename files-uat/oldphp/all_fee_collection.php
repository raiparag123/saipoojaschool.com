														...
														<div class="table-scrollable">
															<table class="table table-striped table-bordered table-hover table-checkable order-column valign-middle"
															 id="example4">
																...
																<tbody>
																<?php 
				$stmt = $mysqli->prepare("select c.registration_id,c.first_name,c.last_name,a.class_name,a.medium,b.roll_no,b.cs_id from class_master a,class_stud_master b,stud_regist_master c where a.class_id=b.class_id and b.student_id=c.registration_id and b.fy_id=? and is_delete=1");
