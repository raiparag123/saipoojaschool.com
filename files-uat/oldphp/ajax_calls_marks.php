	...
	$d[0][3]=$count;
		if($numberofrows == 0 ){
			...
			if($term_id ==2){
				...
				$stmt = $mysqli->prepare("SELECT a.subject_id,b.subject_name FROM class_subject_master a,subject_master b where a.subject_id=b.subject_id and a.fy_id=? and a.class_id=(select b.class_id from stud_regist_master a,class_stud_master b where a.registration_id=b.student_id and b.fy_id=? and a.registration_id=?)");
