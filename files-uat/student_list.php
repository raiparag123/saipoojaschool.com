													...
													<div class="card-body ">
														...
														<div class="table-scrollable">
															<table id="example23" class="display"> 
																...
																<tbody>
																<?php 
																$stmt = $mysqli->prepare("select status,first_name,last_name,stud_image,registration_id,regno,c.class_name,c.medium from stud_regist_master a ,class_stud_master b ,class_master c where a.registration_id = b.student_id and a.is_delete=1  and a.status =1 and b.is_delete =1 and b.fy_id = ?  and b.class_id = c.class_id");
