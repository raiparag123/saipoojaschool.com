...
<link href="../assets/plugins/select2/css/select2.css" rel="stylesheet" type="text/css" />
    <link href="../assets/plugins/select2/css/select2-bootstrap.min.css" rel="stylesheet" type="text/css" />	
				...
				<div class="page-content">
					<div class="page-bar">
						<div class="page-title-breadcrumb">
							<div class=" pull-left">
								<div class="page-title">Class Subject Structure</div>
							</div>
							<!--change_080320#7  remove breadcrumb
								<ol class="breadcrumb page-breadcrumb pull-right">
								<li><i class="fa fa-home"></i>&nbsp;<a class="parent-item" href="index.html">Home</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li><a class="parent-item" href="#">Subject List</a>&nbsp;<i class="fa fa-angle-right"></i>
								</li>
								<li class="active">Subject Name List</li>
							</ol> -->
						</div>
					</div>
					<div class="row">
														...
														<div class="row">
															<div class="col-md-10 col-sm-10 col-10">
																<div class="btn-group">
																	...
																	<button type="button" name="shwsubjectbtn" id="shwsubjectbtn"> Display</button>
															...
															<div class="col-md-4 col-sm-4 col-4">
																...
																<button type="button" style="display: none;"  id="addclasssubject"   class="btn btn-info">
			...
			<div class="modal fade" id="ClassSubjectModal" role="dialog">
