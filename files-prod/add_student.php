...
$transfer="";
	...
	if(isset($_POST['add-student']))
	{
		...
		{
			$ftp_server = "182.50.151.49";
			$ftp_username = "fourlance";
			$ftp_userpass = "qwer123$";
					...
					<div class="row">
						<div class="col-md-12 col-sm-12">
							<div class="card card-box">
								<div class="card-head">
								<!-- change_080320#2 Add below code  -->
