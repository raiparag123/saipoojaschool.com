			...
			<div class="page-header-inner ">
				...
				<div class="top-menu">
					...
					<li class="dropdown language-switch">
							<a class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">Financial Year: <?php echo $_SESSION["year"];?><span class="fa fa-angle-down"></span>
							</a>							
						</li>
						...
						<ul class="sidemenu  page-header-fixed slimscroll-style" data-keep-expanded="false" data-auto-scroll="true"
						 data-slide-speed="200" style="padding-top: 20px">
							...
							<li class="nav-item start">
								...
								<ul class="sub-menu">
									<li class="nav-item">
										<a href="student_list.php" class="nav-link "> <span class="title">Students List</span>
										</a>
									</li>
									<li class="nav-item">
										<a href="all_student.php" class="nav-link "> <span class="title">Student Registry</span>
										</a>
									</li>
									<!--<li class="nav-item">
