...
if(isset($_REQUEST["cs_id"]))	{ 
	...
	$stmt = $mysqli->prepare("select b.first_name,c.class_name,b.regno from class_stud_master a,stud_regist_master b,class_master c where a.student_id = b.registration_id 	and a.class_id=c.class_id and  cs_id=?");
